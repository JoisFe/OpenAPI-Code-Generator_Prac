...
* The original package name 'com.example.openapi-code-generator' is invalid and this project uses 'com.example.openapicodegenerator' instead.
...
* [Mustache](https://docs.spring.io/spring-boot/docs/2.7.15/reference/htmlsingle/index.html#web.servlet.spring-mvc.template-engines)
